...
class Config:
    def __init__(self):
        try:
            ...
            self.BOT_TOKEN = config("BOT_TOKEN", default="7126616735:AAFkbBELMPqsrvnjMrcjxycveQSx_n-LnQM")
            ...
            self.DBNAME = config("DBNAME", default="ENC16u89897")
            ...
            self.OWNER = config("OWNER", default="7030439873")
            ...
            self.RSS_CHAT = config("RSS_CHAT", default=-1002089042135, cast=int)
